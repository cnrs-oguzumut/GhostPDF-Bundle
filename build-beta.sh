...
APP_NAME="GhostPDF+ Beta"
BUILD_DIR="build-beta"
...
# Copy binary
cp ".build/release/GhostPDF+" "$MACOS_DIR/GhostPDF+ Beta"
...
<dict>
    ...
    <string>GhostPDF+ Beta</string>
    <key>CFBundleIconFile</key>
    <string>AppIcon</string>
    <key>CFBundleIdentifier</key>
    <string>com.ghostpdf.app.beta</string>
...
echo "Beta Build complete: $APP_BUNDLE"
